...
const Navbar = () => {
    ...
    const connectWallet = async () => {
      ...
      const abbreviateAddress = (address: string): string => {
        ...
        // Get the first 5 and last 4 characters
      ...
      <div className='flex items-center justify-between p-4'>
          ...
          <div className="flex items-center gap-6 justify-end w-full">
              <div className="bg-white rounded-full flex items-center justify-center cursor-pointer">
                <button onClick={connectWallet} type="button" className="text-white bg-[#050708] hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600 me-2 mb-2">
                    ...
                    {account ? `Connected: ${abbreviateAddress(account)}` : "Connect with MetaMask"}
                </button>
              </div>
              <div className="bg-white rounded-full flex items-center justify-center cursor-pointer">
